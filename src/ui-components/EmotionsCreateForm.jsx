...
export default function EmotionsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setUnder13_src(initialValues.under13_src);
    setUnder13_description(initialValues.under13_description);
    setOver13_src(initialValues.over13_src);
    setOver13_description(initialValues.over13_description);
    setRestricted(initialValues.restricted);
    setErrors({});
  };
  const validations = {
    name: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new Emotions(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "EmotionsCreateForm")}
    >
      <TextField
        label="Name"
        isRequired={false}
